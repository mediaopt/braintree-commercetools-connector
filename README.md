...
The payments demo can be seen at https://mediaopt.github.io/braintree-demo and [demo GitHub repository](https://github.com/mediaopt/braintree-demo).
...
The connector does not currently support multi-tenancy (e.g. different `BRAINTREE_MERCHANT_ID` values per shop, payment method, or country) — please open an issue if you are interested in this, and describe your desired use case.
