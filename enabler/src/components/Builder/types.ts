...
export type BraintreePaymentMethodType =
  ...
  // | "ACHStored" // ACH_STORED_DISABLED: reusing a saved ACH account is out of scope for this build; uncomment to re-enable; please open an issue if you are interested in this stored payment method
  | "ApplePay"
  | "CreditCard"
  | "CreditCardStored"
  ...
  | "GooglePay"
  | "PayPal"
  // | "PayPalStored" // PAYPAL_STORED_DISABLED: PayPal stored cancelled; uncomment to re-enable; please open an issue if you are interested in this stored payment method
