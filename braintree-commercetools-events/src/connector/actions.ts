...
export const BRAINTREE_PARCEL_ADDED_TO_DELIVERY_KEY = 'braintree-commercetools-events-parcelAddedToDelivery';
...
export async function deleteParcelAddedToDeliverySubscription(
    ...
    return await deleteSubscription(BRAINTREE_PARCEL_ADDED_TO_DELIVERY_KEY, apiRoot);
}
